...
<div id="conatiner" style="width:775px; height:930px; background-image:url(images/bg.gif); background-color:#FFF; background-repeat:repeat-x; margin :auto;">
  ...
  <div id="main_content" style=" float:left; width:528px; margin:0px; ">
        ...
        <table width="517" height="490" border="0" style="margin:0px; padding:0px;font-size:12px;">
        <tr>
        <td width="41" height="34" colspan="1"><img src="images/index_32.gif" width="26" height="25" alt=""></td>
        <td colspan="3" style="font-size:17px; color:#74726E; font-weight:bold;"><?php echo $rowa['NAME']?></td>
        </tr>
        <tr><td height="17" colspan="4" style="color:#BDBDBD; font-size:11px;">&nbsp;</td></tr>
        <?php
		if($rowa['ID'] == 2 OR $rowa['ID'] == 3)
		{
		if($rowa['IMAGE'])
		{
       ...
       <?php echo '</td></tr>';
        ...
        <tr>
          <td height="222" colspan="4" style="color:#74726E;"><p align="justify"><?php echo $rowa['DESCRIPTION']?></p></td></tr>
        <?php
		if($rowa['ID'] == 1)
		{
		if($rowa['IMAGE'])
		{
			echo '<tr><td height="143" colspan="4">';
		
		?>
       <img src="admin/<?php echo $rowa['IMAGE']?>" width="133" height="138" />
       <?php echo '</td></tr>';
         } }?> 
         <tr><td height="62" colspan="3" style="color:#74726E; font-size:12px;" align="left"><?php echo $rowa['add_desig']?></td>
         <td width="348"></td></tr>
        </table> 
    </div>
