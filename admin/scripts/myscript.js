...
/*function distellus()
{
	var email = document.tellus.email.value;
	if(document.tellus.city.value == "Select a City")
		{
			alert("Please select a city first.");
			document.tellus.city.focus();
			return false;
		}
	...
	document.tellus.action = "../classes/email_notfound.class.php";
	document.tellus.submit();
}*/
...
//othCity
	...
	{
		var finddot=document.contact.file.value.lastIndexOf('.',document.contact.file.value.length);
		var contain=new String();
		var contain=document.contact.file.value.substring(finddot+1,document.contact.file.value.length);
		var arr=new Array('jpg','jpeg','gif','JPG','JPEG','GIF');
		...
		if(res != "yes")
		{
			alert("Please select jpg, jpeg or gif files only.");
