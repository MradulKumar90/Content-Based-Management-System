...
<?php include("include/leftblock.php")?>
  ...
  <div id="main_content" style=" float:left; width:528px; margin:0px;">
        ...
        <tr><td colspan="4" align="left">
         <img src="admin/<?php echo $rowp['image'];?>" width="348" height="150" /></td></tr>
        <tr>
          <td colspan="4" style="color:#74726E;font-size:12px;"><p align="justify"><?php echo $rowp['description']?></p></td></tr>
