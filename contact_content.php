...
<div id="conatiner" style="width:775px; height:930px; background-image:url(images/bg.gif); background-color:#FFF; background-repeat:repeat-x; margin :auto;">
  ...
  <div id="main_content" style=" float:left; width:528px; margin:0px; ">
        ...
        <table width="517" height="436" border="0" style="margin:0px; padding:0px;font-size:12px;">
        <tr>
        ...
        <tr><td height="193" colspan="4"><img src="admin/<?php echo $rowa['IMAGE']?>" height="180" width="419" />
       
         </td></tr>
        <tr>
          <td height="97" colspan="4" style="color:#00AEDB; font-size:20px"><p align="justify"><?php echo $rowa['DESCRIPTION']?></p></td></tr>
        
         <tr><td height="100" colspan="3" style="color:#74726E; font-size:16px;" align="left"><?php echo $rowa['add_desig']?></td>
         <td width="307" height="21" colspan="1" style="color:#BDBDBD; font-size:11px;">&nbsp;</td></tr>
        </table>  
    </div>
